...
class UsersController extends AppController
{
    ...
    public function updateProfile()
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            if(isset($this->request->data['profile']['birthday']) && $this->request->data['profile']['birthday']) {
                $this->request->data['profile']['birthday'] = date('Y-m-d', strtotime($this->request->data['profile']['birthday']));
            }
