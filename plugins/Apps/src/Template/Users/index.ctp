<?php $this->assign('title', 'Users Lists'); ?>
                ...
                <?php foreach ($users as $user): ?>
                    ...
                    <?php endif; ?>
                        ...
                        <td class="text-right">
                            ...
                            echo $this->Form->postLink("<i class='fa fa fa-trash'></i>",
                                ['controller' => 'users', 'action' => 'delete', $user->uuid],
                                ['confirm' => 'Are you sure you want to delete '. $user->profile->name, 'escape' => false, 'title' => 'Delete', 'class' => 'icons red']
                            );
                            ?>
                        </td>
                    </tr>
